...
class BatteryUtilities {
    static func getBatteryInfo() -> (percentage: Int, isCharging: Bool) {
    ...
    static func percentageToIconName(batteryPercentage: Int, isCharging: Bool) -> String {
